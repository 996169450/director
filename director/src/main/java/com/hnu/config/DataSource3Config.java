...
public class DataSource3Config {
    ...
    public static final String PACKAGE = "com.hnu.mapper.circle";

    public static final String MAPPER_LOCATION = "classpath:mybatis/mapper/circle/*.xml";


    @Value("${jdbc.database03.driverClassName}")
    public String driverClassName;

    @Value("${jdbc.database03.url}")
    public String url;

    @Value("${jdbc.database03.username}")
    public String username;

    @Value("${jdbc.database03.password}")
