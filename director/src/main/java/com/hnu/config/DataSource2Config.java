...
public class DataSource2Config {
    ...
    public static final String PACKAGE = "com.hnu.mapper.eep";

    public static final String MAPPER_LOCATION = "classpath:mybatis/mapper/eep/*.xml";


    @Value("${jdbc.database02.driverClassName}")
    public String driverClassName;

    @Value("${jdbc.database02.url}")
    public String url;

    @Value("${jdbc.database02.username}")
    public String username;

    @Value("${jdbc.database02.password}")
