...
public class DataSource1Config {
    ...
    public static final String PACKAGE = "com.hnu.mapper.cht";

    public static final String MAPPER_LOCATION = "classpath:mybatis/mapper/cht/*.xml";


    @Value("${jdbc.database01.driverClassName}")
    public String driverClassName;

    @Value("${jdbc.database01.url}")
    public String url;

    @Value("${jdbc.database01.username}")
    public String username;

    @Value("${jdbc.database01.password}")
